...
package com.topaz.cameraalert.ListViewSwipe;
...
public class SwipeToDismissTouchListener<SomeCollectionView extends ViewAdapter> implements
    ...
    public class RowContainer {
        ...
        public RowContainer(ViewGroup container) {
            ...
            if (container.getChildCount() == 2)
            {
                ...
                rightContainer = container.getChildAt(1);
                leftContainer = rightContainer;
            }
            else
            {
                leftContainer = container.getChildAt(0);
                rightContainer = container.getChildAt(1);
        ...
        View getSwipingView(boolean mSwipingRight) {
            return mSwipingRight ? rightContainer : leftContainer;
        }

        void showSwipingView(boolean mSwipingRight) {
            View view = mSwipingRight ? rightContainer : leftContainer;
            view.setVisibility(View.VISIBLE);
            if (rightContainer != leftContainer)
            {
                view = mSwipingRight ? leftContainer : rightContainer;
                view.setVisibility(View.GONE);
            }
        }

        View getDataView(boolean mSwipingRight) {
            return dataContainer;
        }

        View getCurrentSwipingView(boolean mSwipingRight) {
            return dataContainerHasBeenDismissed ? (mSwipingRight ? rightContainer : leftContainer) : dataContainer;
        }
    ...
    public interface DismissCallbacks<SomeCollectionView extends ViewAdapter> {
         ...
         */
        boolean canDismiss(int position, boolean swipingRight);
         ...
         */
        void onPendingDismiss(SomeCollectionView recyclerView, int position, boolean swipingRight);

        void onStartSwipe(SomeCollectionView recyclerView, int position);
        /**
         ...
         * @param position The position of the dismissed item.
         */
        void onDismiss(SomeCollectionView recyclerView, int position, boolean swipingRight);
    }
...
*/
                ...
                if (mRowContainer != null) {
                    ...
                    if (mCallbacks.canDismiss(mDownPosition, false)) {
            ...
            case MotionEvent.ACTION_CANCEL: {
                ...
                if (mRowContainer != null && mSwiping) {
                    // cancel
                    mRowContainer.getCurrentSwipingView(mSwipingRight)
                            .animate()
                            .translationX(0)
                            .alpha(1)
                    ...
                    mRowContainer.getCurrentSwipingView(mSwipingRight)
                            ...
                            .setListener(new AnimatorListenerAdapter() {
                                ...
                                public void onAnimationEnd(Animator animation) {
                                    performDismiss(downView, downPosition, swipingRight);
                                }
                            });
                } else {
                    // cancel
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (mSwiping) {
                    mRowContainer.showSwipingView(mSwipingRight);
                    ((View)mRowContainer.getCurrentSwipingView(mSwipingRight).getParent()).setBackgroundColor(mSwipingRight ? Color.RED : Color.GREEN);
                    mRowContainer.getCurrentSwipingView(mSwipingRight).setTranslationX(deltaX - mSwipingSlop);
//                    mRowContainer.getCurrentSwipingView(mSwipingRight).setAlpha(Math.max(0f, Math.min(1f,
//                            1f - 2f * Math.abs(deltaX) / mViewWidth)));
    ...
    class PendingDismissData implements Comparable<PendingDismissData> {
        ...
        public boolean swipingRight;

        public PendingDismissData(int position, RowContainer rowContainer, boolean swipingRight) {
            this.position = position;
            this.rowContainer= rowContainer;
            this.swipingRight = swipingRight;
        }
    ...
    private void performDismiss(RowContainer dismissView, int dismissPosition, boolean swipingRight) {
        ...
        if (mPendingDismiss != null && mPendingDismiss.swipingRight == swipingRight) {
            ...
            addPendingDismiss(dismissView, dismissPosition, swipingRight);
        }
    }

    private void addPendingDismiss(RowContainer dismissView, int dismissPosition, boolean swipingRight) {
        dismissView.dataContainerHasBeenDismissed = true;
        if (swipingRight)
            dismissView.rightContainer.setVisibility(View.VISIBLE);
        else
            dismissView.leftContainer.setVisibility(View.VISIBLE);
    ...
    private void processPendingDismisses(final PendingDismissData pendingDismissData) {
        ...
        animator.addListener(new AnimatorListenerAdapter() {
            @Override
            public void onAnimationEnd(Animator animation) {
                if (mCallbacks.canDismiss(pendingDismissData.position, pendingDismissData.swipingRight))
                    mCallbacks.onDismiss(mRecyclerView, pendingDismissData.position, pendingDismissData.swipingRight);
                pendingDismissData.rowContainer.dataContainer.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        pendingDismissData.rowContainer.leftContainer.setVisibility(View.GONE);
                        pendingDismissData.rowContainer.rightContainer.setVisibility(View.GONE);
